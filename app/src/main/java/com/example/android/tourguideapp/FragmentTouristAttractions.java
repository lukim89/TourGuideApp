...
public class FragmentTouristAttractions extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        place.add(new Place(getString(R.string.sulkowski_castle), getString(R.string.sulkowski_castle_description), getString(R.string.sulkowski_castle_address), getString(R.string.sulkowski_castle_web), getString(R.string.sulkowski_castle_url), getString(R.string.sulkowski_castle_phone), getString(R.string.sulkowski_castle_latitude), getString(R.string.sulkowski_castle_longitude), R.drawable.sulkowski_castle));
        place.add(new Place(getString(R.string.old_factory), getString(R.string.old_factory_description), getString(R.string.old_factory_address), getString(R.string.old_factory_web), getString(R.string.old_factory_url), getString(R.string.old_factory_phone), getString(R.string.old_factory_latitude), getString(R.string.old_factory_longitude), R.drawable.old_factory));
        place.add(new Place(getString(R.string.weaver_house), getString(R.string.weaver_house_description), getString(R.string.weaver_house_address), getString(R.string.weaver_house_web), getString(R.string.weaver_house_url), getString(R.string.weaver_house_phone), getString(R.string.weaver_house_latitude), getString(R.string.weaver_house_longitude), R.drawable.weaver_house));
        place.add(new Place(getString(R.string.falatowka), getString(R.string.falatowka_description), getString(R.string.falatowka_address), getString(R.string.falatowka_web), getString(R.string.falatowka_url), getString(R.string.falatowka_phone), getString(R.string.falatowka_latitude), getString(R.string.falatowka_longitude), R.drawable.falatowka));
        place.add(new Place(getString(R.string.old_town), getString(R.string.old_town_description), getString(R.string.old_town_address), null, null, null, getString(R.string.old_factory_latitude), getString(R.string.old_factory_latitude), R.drawable.old_town));
